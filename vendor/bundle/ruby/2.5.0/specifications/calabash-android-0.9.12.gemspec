# -*- encoding: utf-8 -*-
# stub: calabash-android 0.9.12 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rubyzip>.freeze, ["< 1.3", ">= 1.2.2"])
      ...
      s.add_development_dependency(%q<yard>.freeze, ["< 1.0", ">= 0.9.12"])
      ...
      s.add_dependency(%q<rubyzip>.freeze, ["< 1.3", ">= 1.2.2"])
      ...
      s.add_dependency(%q<yard>.freeze, ["< 1.0", ">= 0.9.12"])
